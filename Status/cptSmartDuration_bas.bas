...
Sub cptUpdateSmartDurationForm(ByRef mySmartDuration_frm As cptSmartDuration_frm)
  ...
  ElseIf oTasks.Count = 0 Then 'Group By Summary
    mySmartDuration_frm.txtTargetFinish = "-"
    mySmartDuration_frm.lblWeekday.Caption = "< invalid >"
    mySmartDuration_frm.lblWeekday.ControlTipText = "Cannot adjust Group By Summary tasks."
    blnValid = False
  ElseIf oTasks(1) Is Nothing Then 'newly inserted task
    mySmartDuration_frm.txtTargetFinish = "-"
    mySmartDuration_frm.lblWeekday.Caption = "< invalid >"
    mySmartDuration_frm.lblWeekday.ControlTipText = "Cannot adjust newly inserted tasks."
    blnValid = False
  ElseIf oTasks.Count > 1 Then 'too many
    mySmartDuration_frm.txtTargetFinish = ""
    mySmartDuration_frm.lblWeekday.Caption = "< focus >"
    mySmartDuration_frm.lblWeekday.ControlTipText = "Please select a single task."
    blnValid = False
  ElseIf oTasks(1).Summary Then
    mySmartDuration_frm.txtTargetFinish = ""
    mySmartDuration_frm.lblWeekday.Caption = "< summary >"
    mySmartDuration_frm.lblWeekday.ControlTipText = "Please select a Non-summary task."
    blnValid = False
  ElseIf IsDate(oTasks(1).ActualFinish) Then
    mySmartDuration_frm.txtTargetFinish = ""
    mySmartDuration_frm.lblWeekday.Caption = "< complete >"
    mySmartDuration_frm.lblWeekday.ControlTipText = "Please select an incomplete task."
    blnValid = False
  End If
